...
| E9 | `robustness_dashboard_v1` | `03_exposure_closure/chao_phraya_robustness_grid/*`, `09_figures_v1/fig4_chao_phraya_robustness_grid.*` | complete | Sensitivity grid and bootstrap outputs are present. |
